...
const ticketRegistration = (event, registration) => {
    let msg =  `<div>
    ...
    <div style="width: 95%; margin:auto; background-color: #ffffff; background: linear-gradient(to right, #b6fbff, pink); border-radius: 10px; padding-left: 8px; box-shadow: 4px 4px 4px grey; border-width: 1px; border-style:solid; border-color: #e8ecee7c;">
    ...
    <p style='text-align: center'>Thank you for using PrepVENT.</p>
</div>`
...
return new Promise((resolve, reject) => {
    ...
    //         email_to: registration.contact,
    //         email_subject: `${event.name} Ticket(s)`,
    //         email_reply_to: 'prepventapp@gmail.com',
    //         email_message: `${sampleMail(msg)}`,
    //         username: 'prepvent',
    //         bulkid: querystring.escape(`TS-${moment.utc().valueOf()}`)
    //     }
    // };
        ...
        transporter.sendMail({
            ...
            to: registration.contact, // list of receivers
            subject:  `${event.name} Ticket(s)`, // Subject line
...
{/* <img src="http://www.barcodesinc.com/generator/image.php?code=${registration.registrationNumber}&style=197&type=C128B&width=200&height=50&xres=1&font=3" alt="barcode" /> */}
